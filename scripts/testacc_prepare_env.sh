...
echo '--- Install ArgoCD ${ARGOCD_VERSION:-v1.5.2}\n\n'
kubectl create namespace argocd &&
kubectl apply -n argocd -f https://raw.githubusercontent.com/argoproj/argo-cd/${ARGOCD_VERSION:-v1.5.2}/manifests/install.yaml &&

...
require (
	...
	github.com/argoproj/argo-cd/gitops-engine c302b8eaa3ad
...
replace github.com/argoproj/argo-cd/gitops-engine => github.com/argoproj/argo-cd/gitops-engine c302b8eaa3ad

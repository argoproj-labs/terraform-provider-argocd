...
require (
	...
	github.com/argoproj/argo-cd/gitops-engine bba10dd8861c
...
replace github.com/argoproj/argo-cd/gitops-engine => github.com/argoproj/argo-cd/gitops-engine bba10dd8861c
